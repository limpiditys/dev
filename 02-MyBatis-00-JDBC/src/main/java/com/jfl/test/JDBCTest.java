...
public class JDBCTest {
    ...
    public void testSelect() {
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/dev02?useSSL=false&characterEncoding=UTF8";
    ...
    public void testAdd() {
        try {
            ...
            // 准备参数
            String url = "jdbc:mysql://localhost:3306/dev02?useSSL=false&useUnicode=true&characterEncoding=UTF8";
            String username = "root";
            String password = "root";
